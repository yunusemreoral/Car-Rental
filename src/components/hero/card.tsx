...
const Card: FC<Props> = ({car}) => {
  ...
  return (
    <div className="car-card group">
       ...
       {/* araç resmi  */}
        <div>
            <img src={generateImage(car)} className="w-full h-full object-contain min-h-[200px]" alt={car.make + " " + car.model} />
        </div>
        ...
        <div className="w-full">
         ...
         className="hidden group-hover:block">
            <Button name="daha fazla" text="Daha Fazla" designs="w-full text-white mt-[0.5px]" fn={() => setIsOpen(true)}/>
         </motion.div>
        </div>
